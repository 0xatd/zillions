...
const names = ['20260820180000_earth_bootstrap_social_parties.sql','20260820203000_earth_region_topology.sql','20260820210000_player_company.sql','20260820214500_encounter_pursuit_authority.sql','20260820230000_siege_governance.sql'];
