...
let called=null;const handler=createLivingWorldGovernanceHandler({config:{url:'x',anonKey:'a',serviceKey:'s'},authenticate:async()=>({id:'actor'}),command:async(actor,command)=>{called={actor,command};return{ok:true};},snapshot:async()=>({sieges:[],reputation:[{score:25}],holdings:[]})});
