...
export const LORE = [
  ...
  ['The Three', 'Captain Scott carries a chainblade that has not been sharpened in nine years; it has not needed it. Alexander speaks to the ground and the ground answers — rangers swear his roots once held a brute for a full bell-toll. And Danny? The horde has never seen Danny. That is rather the point.'],
