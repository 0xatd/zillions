...
class App {
  ...
  _updateDayNight(dt) {
    ...
    // Air thickens as the light dies: the same dread gradient as the sky, in
    // the atmosphere. Distant hordes sink into haze at high Threat.
    this.scene.fog.density = lerp(0.0042, 0.0088, 1 - b);
