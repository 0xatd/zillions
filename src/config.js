...
export const HEROES = {
  ...
  alexander: {
    key: 'alexander', name: 'Alexander', icon: '🔧', color: 0x1f3a6e, trim: 0xb8bfcc,
    tagline: 'Mid range. Combat engineer — walls sing under his hands.',
    hp: 320, dmg: 22, range: 7, rof: 1.3, speed: 4.0, noise: 10,
    levelHp: 32, levelDmg: 3.5, regen: 2.0,
    abilities: [
      { key: 'overcharge', name: 'Overclock', icon: '⚙️', hotkey: 'Q', maxRank: 3, cd: 20,
        cast: 'towerBuff', radius: 11, mult: [1.6, 1.9, 2.3], dur: 9,
        desc: 'Overclocks nearby sentry towers — they fire much faster for 9s.' },
      { key: 'repair', name: 'Field Repairs', icon: '🔩', hotkey: 'W', maxRank: 3, cd: 17,
      ...
      { key: 'coil', name: 'Arc Lash', icon: '🌩️', hotkey: 'E', maxRank: 3, cd: 12,
        ...
        desc: 'A whip of lightning — damages and slows the dead around Alexander.' },
      { key: 'turret', name: 'Sentry Gun', icon: '🤖', hotkey: 'R', ult: true, maxRank: 1, cd: 70,
